        ...
        <td align="right">
			...
			if($data["id_user"] == $_SESSION['id_user_valentina']){
				echo '
					...
					<a href="?pg=retos&id='.$data["id"].'"><img src="img/ico_edit.png" width="22" class="ico_edit_opt"/></a>
				';
			}
			?>
        </td>
    ...
    <table width="100%" >
		<tr>
			<td align="center" width="33%" class="bt_option_card" onclick="Me_Gusta(<?php echo $data["id"]; ?>)">
                    	<img src="img/ico_like_stroke.png" width="50" /> Me gusta
			</td>
			<td align="center" class="bt_option_card" onclick="Comentar(<?php echo $data["id"]; ?>)"> <img src="img/ico_comment.png" width="50"/> Comentar</td>
		</tr>
	</table>
