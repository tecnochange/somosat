...
<div class="container-fluid">
	...
	<div align="left" class="cabecera_interna">
		<table width="100%">
			<tr>
				<td><h2>Gestionar Proveedores</h2></td>
    ...
    <table class="table">
        <thead class="thead-success">
            <tr>
                ...
                <th scope="col" width="100" align="center">
                    ...
                    <a href="<?php echo $url; ?>?pg=formacion/proveedor/detalle">
        ...
        <tbody class="tabla_lista">
            <?php
                $count = 1;
                $query = mysqli_query($connect_formacion,"SELECT * FROM Proveedores ORDER BY nombre ASC ");  
                while($data = mysqli_fetch_array($query)){ 
                    ...
                    if($user_log["role"] == 1){
                        $bt_editar = '
                            <a href="'.$url.'?pg=formacion/proveedor/detalle&id='.$data["id"].'">
...
<script>  
	...
	function Eliminar(id){
        ...
        if(activar == false){
            ...
            jQuery.ajax({
                url: api+"eliminar_proveedor.php",
                type:'post',
                data: {id: id, url:"?pg=formacion/proveedores"},
                }).done(function (resp){
                    $("#xscript").html(resp);
                })
                .fail(function(resp) {
