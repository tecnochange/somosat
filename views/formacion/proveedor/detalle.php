...
$(document).ready(function(){
    $("#bt_formacion_proveedores").addClass("active_item");
...
<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
			...
			$sentencia = "
			INSERT INTO Proveedores ( nombre , estado , created_at ) 
			VALUES 
            ...
            echo '<script> window.location = "?pg=formacion/proveedores";</script>';//para evitar reinsersion  
		}
	...
	$query = mysqli_query($connect_formacion,"SELECT * FROM Proveedores WHERE id = '".$id."' ");
...
<div class="container">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=formacion/proveedores">Proveedores</a></li>
