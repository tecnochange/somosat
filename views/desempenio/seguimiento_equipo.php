    ...
    <div class="row">
        ...
        <div class="col-md-12" style="margin-bottom: 20px">
            <table width="100%">
                <tr>
                    <td>
                        <h2>
                            Seguimiento Equipo <?php echo $_SESSION["anio"]; ?>
                        </h2>
        ...
        <div class="col-md-12">
            ...
            while($dataJefes = mysqli_fetch_array($queryJefes)){
                ...
                $queryEmpleados = mysqli_query($connect_valentina,"SELECT * FROM Empleados WHERE id = '".$dataJefes["id_empleado"]."' AND estado = 1 "); 
                $dataEmpleados = mysqli_fetch_array($queryEmpleados);
				
				if($queryEmpleados->num_rows > 0){

                    $colaborador = $ClassColaboradores->colaborador( $connect_valentina, $dataJefes["id_empleado"] );
                
					$queryValidar = mysqli_query($connect_desempenio,"SELECT * FROM Aprobaciones_Objetivos 
					WHERE anio = '".$_SESSION['anio']."' 
					AND id_empleado = '".$dataEmpleados["id_empleado"]."' ORDER BY id ASC "); 
            ...
            <div class="card ficha_colaborador" style="margin-bottom: 15px">
                <div class="card-body">
                    ...
                    <h4><?php echo $colaborador[0]["nombre_completo"]; ?></h4>
