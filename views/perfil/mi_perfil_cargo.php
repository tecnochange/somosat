...
<?php
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Cargos WHERE id = '".$user_log["id_cargo"]."'  ");
	$data = mysqli_fetch_array($query);	

    $queryDescriptivo = mysqli_query($connect_valentina,"SELECT * FROM Cargos_Descriptivo WHERE id_cargo = '".$user_log["id_cargo"]."'  ");
