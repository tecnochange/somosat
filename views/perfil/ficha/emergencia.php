...
<?php
    ...
    $queryInforma = mysqli_query($connect_valentina,"SELECT * FROM Empleados_Emergencia WHERE id_empleado = '".$_SESSION["id_user"]."' ");
...
<div class="container"> 
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=perfil/ficha/emergencia" class="nav-link active">En Caso de Emergencia</a>
            </li>
    </ul>
...
function Eliminar_Emergencia(id_registro){
	jQuery.ajax({
		...
		type:'post',
		data: {id_registro: id_registro, url:"<?php echo $url; ?>?pg=perfil/ficha/emergencia"},
		}).done(function (resp){
			$("#xscript").html(resp);
		})
		.fail(function(resp) {
