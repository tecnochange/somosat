...
<div class="container"> 
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=perfil/ficha/academico" class="nav-link active">Académico</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-body"> 
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <th>Soporte</th>
                    <th width="90">
                        <a href="<?php echo $url; ?>?pg=perfil/ficha/academico">
	            ...
	            while($dataAcademico = mysqli_fetch_array($queryAcademico)){
                    ...
                    <tr>
                        ...
                        <td>
                           <a href="'.$url.'?pg=perfil/ficha/academico&acd='.$dataAcademico["id"].'"> 
            ...
            <table class="table table-bordered">
	            ...
	            while($dataAcademicoIdm = mysqli_fetch_array($queryAcademicoIdm)){
                    ...
                    <tr>
                        ...
                        <td>
                           <a href="'.$url.'?pg=perfil/ficha/academico&idm='.$dataAcademicoIdm["id"].'"> 
                            <button type="button" class="btn btn-success btn-sm" >
                                <i class="fa fa-check"></i>
                            </button>
                            </a>
            ...
            <table class="table table-bordered">
	            ...
	            while($dataAcademicoHab = mysqli_fetch_array($queryAcademicoHab)){
                    ...
                    <tr>
                        ...
                        <td>
                           <a href="'.$url.'?pg=perfil/ficha/academico&hab='.$dataAcademicoHab["id"].'"> 
                            <button type="button" class="btn btn-success btn-sm" >
                                <i class="fa fa-check"></i>
                            </button>
                            </a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12" style="margin-bottom: 10px">
                    ...
                    <textarea type="text" class="form-control" name="habilidades" value="<?php echo $dataInforma3["habilidades"]; ?>"></textarea>
                </div>
...
function Eliminar_Academico(id_registro){
	...
	jQuery.ajax({
		...
		type:'post',
		data: {id_registro: id_registro, url:"<?php echo $url; ?>?pg=perfil/ficha/academico"},
		}).done(function (resp){
			$("#xscript").html(resp);
		})
		.fail(function(resp) {
