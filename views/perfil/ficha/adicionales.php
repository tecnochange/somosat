...
<?php
    ...
    $queryInforma = mysqli_query($connect_valentina,"SELECT * FROM Empleados_Adicionales WHERE id_empleado = '".$_SESSION["id_user"]."' ");
...
<div class="container"> 
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=perfil/ficha/adicionales" class="nav-link active">Datos Personales</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-body">   
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="margin-bottom: 10px">
                    ...
                    <input type="date" class="form-control" name="fecha_ingreso" readonly value="<?php echo $dataInforma["fecha_ingreso"]; ?>">
                </div>
                ...
                <div class="col-md-4" style="margin-bottom: 10px">
                    ...
                    <input type="text" class="form-control" name="cod_colaborador" readonly value="<?php echo $dataInforma["cod_colaborador"]; ?>">
                </div>
                ...
                <div class="col-md-4" style="margin-bottom: 10px">
                    ...
                    <input type="text" class="form-control" name="cliente" readonly  value="<?php echo $dataInforma["cliente"]; ?>" >
                </div>
                
                <div class="col-md-4" style="margin-bottom: 10px">
                    <label for="lastName">Dirección de Cliente:</label>
                    <input type="text" class="form-control" name="dr_cliente" readonly  value="<?php echo $dataInforma["dr_cliente"]; ?>" >
                </div>
                
                <div class="col-md-4" style="margin-bottom: 10px">
                    <label for="lastName">Correo de Outsourcing:</label>
                    <input type="text" class="form-control" name="correo_ou" readonly placeholder="@" value="<?php echo $dataInforma["correo_ou"]; ?>" >
                </div>
                
                <div class="col-md-12" style="margin-bottom: 10px">
                    <label for="lastName">Horario del Servicio:</label>
                    <input type="text" class="form-control" name="h_servicio" readonly  value="<?php echo $dataInforma["h_servicio"]; ?>" >
                </div>
                ...
                <div class="col-md-4 cajas_dep_indep dependiente independiente" style="margin-bottom: 10px">
                    <label>Banco:</label>
  ...
  <!-- datos de contacto -->              
                ...
                <div class="col-md-4 departamento_ciudad" style="margin-bottom: 10px">
...
function Eliminar(id_registro){
	jQuery.ajax({
		...
		type:'post',
		data: {id_registro: id_registro, url:"<?php echo $url; ?>?pg=perfil/ficha/adicionales"},
		}).done(function (resp){
			$("#xscript").html(resp);
		})
		.fail(function(resp) {
