...
<?php
    ...
    $queryInforma = mysqli_query($connect_valentina,"SELECT * FROM Empleados_Preferencias WHERE id_empleado = '".$_SESSION["id_user"]."' ");
...
<div class="container"> 
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=perfil/ficha/preferencia" class="nav-link active">RSE</a>
            </li> 
            <li class="nav-item">
...
<!-- esto se agrego nuevo -->     
                ...
                <div class="col-md-12" style="margin-bottom: 10px">
                    <label><b>¿Estarías Dispuesto a Drindar Tus Conocimientos Académicos a Otros que lo Requieran?</b></label>
                    <div class="row">
                    <?php
