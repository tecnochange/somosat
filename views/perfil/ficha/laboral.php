...
<div class="container"> 
    ...
    <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=perfil/ficha/laboral" class="nav-link active">Experiencia Laboral</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-body"> 
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <th>Soporte</th>
                    <th width="90">
                        <a href="<?php echo $url; ?>?pg=perfil/ficha/laboral">
	            ...
	            while($datalaboral = mysqli_fetch_array($querylaboral)){
                    ...
                    <tr>
                        ...
                        <td>
                           <a href="'.$url.'?pg=perfil/ficha/laboral&lab='.$datalaboral["id"].'"> 
...
<script>
	...
	function Eliminar_Laboral(id_registro){
		jQuery.ajax({
			...
			type:'post',
			data: {id_registro: id_registro, url:"<?php echo $url; ?>?pg=perfil/ficha/laboral"},
			}).done(function (resp){
				$("#xscript").html(resp);
			})
			.fail(function(resp) {
