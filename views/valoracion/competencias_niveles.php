...
<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_tipo"] != ""){
			...
			mysqli_query($connect_valoracion,"INSERT INTO Niveles (id_empresa, anio, id_ciclo, nombre, created_at, update_at) 
			VALUES 
...
<?php include("views/valoracion/layouts/ficha_nivel.php"); ?>
<?php echo $respuesta; ?>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><b>NIVELES</b></li>
  </ol>
</nav>

<div align="right" style="display: none">
    <a href="<?php echo $url; ?>?pg=valoracion/replicas/niveles_replicar">
...
<ul class="nav nav-tabs">  
  ...
  <li class="nav-item">
    <a class="nav-link active" href="?pg=valoracion/competencias_niveles">Niveles</a>
  </li>
...
<table class="table table-bordered">
	...
	<tr>
		...
		<th scope="col" style="width: 45px;">
            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target=".modal_nivel" onclick="Seter_Ficha()" title="Crear">
	...
	<?php
		$count = 1;
		$query = mysqli_query($connect_valoracion,"SELECT * FROM Niveles WHERE id_empresa = '".$_SESSION['id_empresa']."' AND anio = '".$_SESSION['anio']."' 
		...
		while($data = mysqli_fetch_array($query)){
			...
			<tr>
                ...
                <td>'.$dataCl["nombre"].'</td>
				<td align="center">
					<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target=".modal_nivel" onclick="Ficha_Nivel('.$data["id"].')">
