<?php
	...
	if($_POST["actualizar"] != ""){
        ...
        $queryTmp = mysqli_query($connect_valoracion,"SELECT * FROM Perfiles_Cargos WHERE id_cargo = '".$id."' AND anio = '".$_SESSION["anio"]."' ");
        if($queryTmp->num_rows == 0){
            ...
            VALUES ('".$_SESSION["anio"]."', '".$_SESSION["ciclo"]."', '".$_SESSION["id_empresa"]."', '".$id."', '', '".$hoy."' ) ");
        }
        ...
        mysqli_query($connect_valoracion,"UPDATE Perfiles_Cargos SET perfiles = '".$peril."' WHERE id_cargo = '".$id."' AND anio = '".$_SESSION["anio"]."' AND id_ciclo = '".$_SESSION['ciclo']."'  ");
    ...
    $queryCargo = mysqli_query($connect_valentina,"SELECT * FROM Cargos WHERE id = '".$id."' ");
	$dataCargo = mysqli_fetch_array($queryCargo);
    
    $queryC = mysqli_query($connect_valoracion,"SELECT * FROM Perfiles_Cargos WHERE id_cargo = '".$id."' AND anio = '".$_SESSION["anio"]."' 
