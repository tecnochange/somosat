<?php
    ...
    if($_POST["guardar_replicar"] != ""){
        $queryEvalTmp = mysqli_query($connect_valoracion,"SELECT * FROM Niveles WHERE id_ciclo = '".$_POST["id_ciclo_anterior"]."' ");  
        ...
        echo '<script> window.location = "'.$url.'?pg=valoracion/competencias_niveles"; </script>';
    }
        ...
        <div class="col-md-12">
            <table width="100%" style="margin-bottom: 10px">
                <tr>
                    ...
                    <td align="right">
                        <a href="<?php echo $url; ?>?pg=valoracion/competencias_niveles">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-sm" style="margin-top: 15px">
                        ...
                        <?php
                            $count = 1;
                            $query = mysqli_query($connect_valoracion,"SELECT * FROM Niveles WHERE id_empresa = '".$_SESSION['id_empresa']."' AND 
                            anio = '".$dataCicloAnterior['anio']."' ORDER BY nombre DESC ");
