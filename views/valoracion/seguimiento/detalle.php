...
<nav aria-label="breadcrumb" style="margin-top: 15px;">
  <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="?pg=valoracion/formularios">Formularios Valoración</a></li>
...
foreach($perfiles as $prf){
    ...
    id_competencia = '".$dataComp["id"]."' AND id_evaluador = '".$dataEvaluacion["id_evaluador"]."' AND id_evaluado = '".$dataEvaluacion["id_evaluado"]."' 
    AND id_ciclo = '".$dataEvaluacion["id_ciclo"]."' ORDER BY id DESC ");
    ...
    <div class="card-body" align="center">
        ...
        <table width="100%">
            ...
            while($dataPreguntas = mysqli_fetch_array($queryPreguntas)){
                ...
                WHERE id_competencia = '".$dataComp["id"]."' AND id_comportamientos = '".$dataPreguntas["id"]."' AND id_respuesta = '".$dataRespTemp["id"]."' 
                AND id_ciclo = '".$dataEvaluacion["id_ciclo"]."' ORDER BY id DESC ");
                ...
                echo '
                        <tr>
                            ...
                            <td width="50">1 <input type="checkbox" class="checkbox_list comp_'.$dataPreguntas["id"].'" name="comp_'.$dataComp["id"].'[]" value="'.$dataPreguntas["id"].', 1" '.$check_true_1.' onClick="SelectCheck(this, '.$dataPreguntas["id"].')" ></td>
                            <td width="50">2 <input type="checkbox" class="checkbox_list comp_'.$dataPreguntas["id"].'" name="comp_'.$dataComp["id"].'[]" value="'.$dataPreguntas["id"].', 2" '.$check_true_2.' onClick="SelectCheck(this, '.$dataPreguntas["id"].')" ></td>
                            <td width="50">3 <input type="checkbox" class="checkbox_list comp_'.$dataPreguntas["id"].'" name="comp_'.$dataComp["id"].'[]" value="'.$dataPreguntas["id"].', 3" '.$check_true_3.' onClick="SelectCheck(this, '.$dataPreguntas["id"].')" ></td>
                            <td width="50">4 <input type="checkbox" class="checkbox_list comp_'.$dataPreguntas["id"].'" name="comp_'.$dataComp["id"].'[]" value="'.$dataPreguntas["id"].', 4" '.$check_true_4.' onClick="SelectCheck(this, '.$dataPreguntas["id"].')" ></td>
                        </tr>
                ';
                $count_int++;
