...
<div align="left" style="padding: 10px 0px;">
	<table width="100%">
    	<tr>
        	<td><h5 style="margin-top: 8px;">Informes Valoración</h5></td>
            <td align="right">
...
<table class="table table-bordered table-sm">
	...
	<?php
		...
		$count = 1;
		$query = mysqli_query($connect_valoracion,"SELECT * FROM Competencias_Evaluaciones WHERE id = '".$dtCargo["id"]."' ORDER BY id DESC ");
