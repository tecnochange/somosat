    ...
    <div class="card-body" align="center">
        ...
        <div class="row">
            <div class="col-md-12" align="left">
                ...
                ?>
                <div style="margin-bottom: 20px" title="<?php echo $id_evaluado."-".$_SESSION['id_empresa']." - ".$_SESSION['ciclo']; ?>">
            ...
            <div class="col-md-12" align="left">
                ...
                <table>
                    ...
                    foreach($perfiles as $prf){
                        ...
                        $PROMEDIO_COMPETENCIA = PromedioGeneralEvaluado( $connect_valoracion, $connect_valentina, $id_evaluado, $dataComp["id"], 0 );
                        $promedio_compt = $PROMEDIO_COMPETENCIA["total"];
...
/*
    ...
    $queryCompetencias = mysqli_query($connect_valoracion,"SELECT * FROM Competencias_Respuestas_Comportamientos WHERE id_evaluado = '".$id_evaluado."' GROUP BY id_competencia ");
    while($dataCompetencias = mysqli_fetch_array($queryCompetencias)){
        ...
        $ponderacion_empleado = PromedioGeneralEvaluado( $connect_valoracion, $connect_valentina, $id_evaluado, $dataCompetencias["id_competencia"] );
        $promedio = $ponderacion_empleado["total"];
...
foreach($perfiles as $prf){
    ...
    while($dataRespuestas = mysqli_fetch_array($queryRespuestas)){
        ...
        $total_cal = 0;
        $cant_resp = 0;
        $queryCal = mysqli_query($connect_valoracion,"SELECT * FROM Competencias_Respuestas_Comportamientos WHERE 
        id_evaluado = '".$id_evaluado."' AND 
        id_competencia = '".$dataComp["id"]."' AND 
        id_comportamientos = '".$dataRespuestas["id_comportamientos"]."' AND 
...
<div class="card" style="margin-bottom: 15px">
    <div class="card-body" align="center">
        ...
        <div align="left"><?php echo $comentarios_evaluaciones; ?></div>
