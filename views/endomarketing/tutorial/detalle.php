<?php
	...
	if($_POST["titulo"] != ""){
		...
		if($_POST["id_registro"] != ""){
			mysqli_query($connect_admin,"UPDATE Tutoriales SET titulo = '".$_POST["titulo"]."', youtube = '".$script."', orden = '".$_POST["orden"]."', estado = '".$_POST["estado"]."' WHERE id = '".$_POST["id_registro"]."'  ");
			...
			mysqli_query($connect_admin,"INSERT INTO Tutoriales (titulo, youtube, orden, estado, created_at ) 
			VALUES 
			( '".$_POST["titulo"]."', '".$script."', '".$_POST["orden"]."', '".$_POST["estado"]."', '".$hoy."' ) "); 

            echo '<script> window.location = "?pg=endomarketing/tutoriales";</script>';
		}
	...
	$query = mysqli_query($connect_admin,"SELECT * FROM Tutoriales WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=endomarketing/tutoriales">Tutoriales</a></li>
...
$( document ).ready(function() {
    ...
    $("#bt_endo_tutoriales").addClass("active");
});
</script>