<?php
	...
	if($_POST["titulo"] != ""){
		...
		if($_POST["id_registro"] != ""){
			mysqli_query($connect_admin,"UPDATE Herramientas SET titulo = '".$_POST["titulo"]."', link = '".$_POST["link"]."', responsable = '".$_POST["responsable"]."', orden = '".$_POST["orden"]."', estado = '".$_POST["estado"]."' WHERE id = '".$_POST["id_registro"]."'  ");
			
			if( $_FILES['archivo']["name"] ){
				$archivo = Subir_Documento($_FILES['archivo']);
				mysqli_query($connect_admin,"UPDATE Herramientas SET archivo = '".$archivo."'  WHERE id = '".$_POST["id_registro"]."'  ");
			}
			...
			mysqli_query($connect_admin,"INSERT INTO Herramientas (titulo, archivo, link, responsable, orden, estado, created_at ) 
			VALUES 
			( '".$_POST["titulo"]."', '".$archivo."', '".$_POST["link"]."', '".$_POST["responsable"]."', '".$_POST["orden"]."', '".$_POST["estado"]."', '".$hoy."' ) "); 

            echo '<script> window.location = "?pg=endomarketing/herramientas";</script>';
		}
	...
	$query = mysqli_query($connect_admin,"SELECT * FROM Herramientas WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=endomarketing/herramientas">Herramientas</a></li>
        ...
        <div class="card-body">   
            ...
            <div class="row">
				...
				<div class="col-md-4" style="margin-bottom: 10px">
                    ...
                    <input type="text" class="form-control" name="responsable" value="<?php echo $data["responsable"]; ?>">
                </div>
				
				<div class="col-md-4" style="margin-bottom: 10px">
                    <label>Icono (El archivo no debe pasar los 1.9 megas)</label>
