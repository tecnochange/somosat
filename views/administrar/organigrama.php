...
<div class="container-fluid"> 
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin-bottom: 10px">
                    <lable>Seleccione el area que desea visualizar</lable>
                    <select class="form-control" name="padre">
                        <option value="">Selecciona..</option>
                        <?php
                        $queryJer = mysqli_query($connect_valentina,"SELECT * FROM Areas ORDER BY jerarquia ");  
        ...
        <div class="col-md-12">
            ...
            <?php
                ...
                $query = mysqli_query($connect_valentina,"SELECT * FROM Cargos WHERE jerarquia = 1 AND id_empresa = '".$_SESSION['id_empresa']."' ");  //NIVEL 1
                while($data = mysqli_fetch_array($query)){
                    
                    $link = '';
                    if($dtEmpleado["role"] == 1){
                        $link = $url.'?pg=administrar/cargos/detalle&id='.$dataHijo["id"]; 
                    }
                    
                    echo '<li>
                        <a href="'.$link.'">
                            '.$data["nombre"].'
                            '.(Empleados($connect_valentina, $data["id"])).'
                        </a>
                    ';
                    ...
                    while($dataHijo = mysqli_fetch_array($queryHijo)){
                        ...
                        $link2 = '';
                        if($dtEmpleado["role"] == 1){
                           $link2 = $url.'?pg=administrar/cargos/detalle&id='.$dataHijo["id"]; 
                        }
                        ...
                        <li>
                            <a href="'.$link2.'">
                                <b>'.$dataHijo["nombre"].'</b>
                                '.(Empleados($connect_valentina, $dataHijo["id"])).'
                            </a>
                        ';
                        ...
                        while($dataHijo2 = mysqli_fetch_array( $queryHijo2 )){
                            ...
                            echo '
                            <li>
                                <a href="'.$url.'?pg=administrar/cargos/detalle&id='.$dataHijo2["id"].'">
                                    '.$dataHijo2["nombre"].'
                                </a>
                            ';
                            ...
                            while($dataHijo3 = mysqli_fetch_array( $queryHijo3 )){
                                ...
                                echo '
                                <li>
                                    <a href="'.$url.'?pg=administrar/cargos/detalle&id='.$dataHijo3["id"].'">
                                        '.$dataHijo3["nombre"].'
                                    </a>
                                ';
                                ...
                                while($dataHijo4 = mysqli_fetch_array( $queryHijo4 )){
                                    ...
                                    echo '
                                    <li>
                                        <a href="'.$url.'?pg=administrar/cargos/detalle&id='.$dataHijo4["id"].'">
                                            '.$dataHijo4["nombre"].'
                                        </a>
                                    ';
                                    //echo '<ul>';
