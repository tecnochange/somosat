<div class="container-fluid"> 
    ...
    <div class="row">
        ...
        <ul class="nav nav-tabs">
              <li class="nav-item">
                <a href="<?php echo $url; ?>?pg=administrar/cargos" class="nav-link active" >Inventario Cargo</a>
              </li>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered" style="margin-top: 15px">
                ...
                <?php
                    ...
                    $query = mysqli_query($connect_valentina,"SELECT * FROM Cargos WHERE id_empresa = '".$_SESSION['id_empresa']."' AND id = '".$dtCargo["id"]."' ORDER BY nombre ASC ");
