    ...
    <div class="row">
        <div class="col-md-12">
			...
			<ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
				<li class="nav-item">
					<a class="nav-link " href="<?php echo $url; ?>?pg=administrar/cargo/resumen">
                    ...
                    <div class="tab-content" id="top-tabContent">
                        <div class="tab-pane fade show active" id="top-configuracion" role="tabpanel" aria-labelledby="top-configuracion-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="margin-bottom: 10px">
                                    <textarea rows="20" class="form-control" name="decisiones_tomar"><?php echo $dataDescriptivo["decisiones_tomar"]; ?></textarea>
                                </div>
