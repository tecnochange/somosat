<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/nacionalidades/nacionalidad";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Nacionalidad WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/nacionalidades/nacionalidad">Nacionalidad</a></li>
