<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/tipo_documento/tipo_documento";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Tipo_Documento WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/tipo_documento/tipo_documento">Tipo de Documento</a></li>
