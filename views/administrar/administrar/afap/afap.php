        ...
        <table class="table table-bordered">
            <thead class="thead-success">
                <tr>
                    ...
                    <th scope="col">Afap</th>
                    <th scope="col">Estado</th>
                    <th scope="col" width="60" align="center">
                        
                            <a href="<?php echo $url; ?>?pg=administrar/administrar/afap/detalle">
            ...
            <tbody class="tabla_lista">
                <?php
                    $count = 1;
                    $query = mysqli_query($connect_valentina,"SELECT * FROM Afap ORDER BY nombre ASC ");  
                    while($data = mysqli_fetch_array($query)){ 
                        ...
                        if($user_log["role"] == 1){
                            $bt_editar = '
                                <a href="'.$url.'?pg=administrar/administrar/afap/detalle&id='.$data["id"].'">
