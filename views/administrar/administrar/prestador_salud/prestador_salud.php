...
$(document).ready(function(){
    ...
    <div align="left" class="cabecera_interna">
        <table width="100%">
            <tr>
                <td><h2>Prestador de Salud</h2></td>
            </tr>
        </table>
    </div>
        ...
        <table class="table table-bordered">
            <thead class="thead-success">
                <tr>
                    ...
                    <th scope="col">Prestador de Salud</th>
                    <th scope="col">Estado</th>
                    <th scope="col" width="60" align="center"> 
                        <a href="<?php echo $url; ?>?pg=administrar/administrar/prestador_salud/detalle">
            ...
            <tbody class="tabla_lista">
                <?php
                    $count = 1;
                    $query = mysqli_query($connect_valentina,"SELECT * FROM Prestador_Salud ORDER BY nombre ASC ");  
                    while($data = mysqli_fetch_array($query)){ 

                        $queryCompania = mysqli_query($connect_valentina,"SELECT * FROM Prestador_Salud WHERE nombre = '".$data["nombre"]."' ");  
                        ...
                        if($user_log["role"] == 1){
                            $bt_editar = '
                                <a href="'.$url.'?pg=administrar/administrar/prestador_salud/detalle&id='.$data["id"].'">
