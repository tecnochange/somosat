<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/prestador_salud/prestador_salud";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Prestador_Salud WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/prestador_salud/prestador_salud">Prestador de Salud</a></li>
