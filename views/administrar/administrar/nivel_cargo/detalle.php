<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/nivel_cargo/nivel_cargo";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Niveles_Cargo WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/nivel_cargo/nivel_cargo">Nivel del Cargo</a></li>
