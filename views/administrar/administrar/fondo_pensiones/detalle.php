<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            $queryFondo_Pensiones = mysqli_query($connect_valentina,"SELECT * FROM Fondo_Pensiones WHERE id = '".$_POST["id_registro"]."' ");  
            $dataFondo_Pensiones = mysqli_fetch_array($queryArl);
            
            $resumen = 'Edición Fondo_Pensiones:\n';
            if($dataFondo_Pensiones["nombre"] != $_POST["nombre"] ){ $resumen .= 'Nombre: '.$_POST["nombre"].'\n'; }
            if($dataFondo_Pensiones["estado"] != $_POST["estado"] ){ $resumen .= 'Estado: '.$_POST["estado"].'\n'; }
            
            GuardarNovedad($connect_valentina, "Edición Fondo_Pensiones", $_SESSION["id_user_valentina"], $resumen, $_POST["id_registro"] );
			//CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
			//CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
            
			$sentencia = "
            UPDATE Fondo_Pensiones SET 
                nombre = '".$_POST["nombre"]."', 
                estado = '".$_POST["estado"]."'  
            ...
            //CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
			//CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
            $resumen = 'Creación Fondo_Pensiones:\n';
            if($dataFondo_Pensiones["nombre"] != $_POST["nombre"] ){ $resumen .= 'Nombre: '.$_POST["nombre"].'\n'; }
            if($dataFondo_Pensiones["estado"] != $_POST["estado"] ){ $resumen .= 'Estado: '.$_POST["estado"].'\n'; }
            
            GuardarNovedad($connect_valentina, "Creación Fondo_Pensiones", $_SESSION["id_user_valentina"], $resumen, 0 );
			//CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
			//CODIGO PARA OBTENER LOS DATOS QUE SERÁN GUARDADOS EN LAS NOVEDADES
            
            
            $sentencia = "
            INSERT INTO Fondo_Pensiones ( 
                nombre, 
                estado, 
                created_at
            ) 
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/fondo_pensiones/fondo_pensiones";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Fondo_Pensiones WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/fondo_pensiones/fondo_pensiones">Fondo de Pensiones y Cesantías</a></li>
...
<div class="card">
        ...
        <div class="card-body">   
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h2>Detalle Fondo de Pensiones y Cesantías</h2>
                    <input type="hidden" name="id_registro" value="<?php echo $id; ?>">
                </div>
                
                <div class="col-md-6" style="margin-bottom: 10px">
                    <label>Fondo de Pensiones y Cesantías</label>
