...
$(document).ready(function(){
    ...
    <div align="left" class="cabecera_interna">
        <table width="100%">
            <tr>
                <td><h2>Fondo de Pensiones y Cesantías</h2></td>
            </tr>
        </table>
    </div>
        ...
        <table class="table table-bordered">
            <thead class="thead-success">
                <tr>
                    ...
                    <th scope="col">Fondo de Pensiones y Cesantías</th>
                    <th scope="col">Estado</th>
                    <th scope="col" width="60" align="center">
                        <a href="<?php echo $url; ?>?pg=administrar/administrar/fondo_pensiones/detalle">
                            <button type="button" class="btn btn-outline-primary" title="Nuevo">
                                Crear Fondo de Pensiones y Cesantías
                            </button>
                        </a>
                    </th>
                </tr>
            ...
            <tbody class="tabla_lista">
                <?php
                    $count = 1;
                    $query = mysqli_query($connect_valentina,"SELECT * FROM Fondo_Pensiones ORDER BY nombre ASC ");  
                    while($data = mysqli_fetch_array($query)){ 

                        $queryCompania = mysqli_query($connect_valentina,"SELECT * FROM Fondo_Pensiones WHERE nombre = '".$data["nombre"]."' ");  
                        ...
                        if($user_log["role"] == 1){
                            $bt_editar = '
                                <a href="'.$url.'?pg=administrar/administrar/fondo_pensiones/detalle&id='.$data["id"].'">
