<?php
	...
	if($_POST["nombre"] != ""){
		...
		if($_POST["id_registro"] != ""){
            ...
            echo '
            <script>
                window.location = "?pg=administrar/administrar/tipo_cap/lista";
            </script>
            ';
	...
	$query = mysqli_query($connect_valentina,"SELECT * FROM Tipo_Capacitacion WHERE id = '".$id."' ");
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=administrar/administrar/tipo_cap/lista">Tipo Capacitación</a></li>
...
<div class="card">
        ...
        <div class="card-body">   
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h2>Detalle Tipo Capacitación</h2>
