...
$(document).ready(function(){
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo $url; ?>?pg=home">Inicio</a></li>
        ...
        <table class="table table-bordered">
            <thead class="thead-success">
                <tr>
                    ...
                    <th scope="col">Tipo Capacitacion</th>
                    <th scope="col">Estado</th>
                    <th scope="col" width="100" align="center">
                        
                            <a href="<?php echo $url; ?>?pg=administrar/administrar/tipo_cap/detalle">
            ...
            <tbody class="tabla_lista">
                <?php
                    $count = 1;
                    $query = mysqli_query($connect_valentina,"SELECT * FROM Tipo_Capacitacion ORDER BY nombre ASC ");  
                    while($data = mysqli_fetch_array($query)){ 
                        ...
                        if($user_log["role"] == 1){
                            $bt_editar = '
                                <a href="'.$url.'?pg=administrar/administrar/tipo_cap/detalle&id='.$data["id"].'">
