...
function Nodo($padre, $connect_valentina){
    
    $queryHijo = mysqli_query($connect_valentina,"SELECT * FROM Areas WHERE padre = '".$padre."' "); //NIVEL 2
...
<div align="left" class="cabecera_interna">
	<table width="100%">
    	<tr>
        	<td><h2>Administrar Organigrama</h2></td>
                        ...
                        while($dataHijo2 = mysqli_fetch_array( $queryHijo2 )){
                            ...
                            while($dataHijo3 = mysqli_fetch_array( $queryHijo3 )){
                                ...
                                while($dataHijo4 = mysqli_fetch_array( $queryHijo4 )){
                                    ...
                                    $link_4 = '';
                                    if($user_log["role"] == 1){
                                        $link_4 = ' href="'.$url.'?pg=administrar/area/detalle&id='.$dataHijo4["id"].'" '; 
                                    }
                                    ...
                                    if($queryHijo5->num_rows > 0){ echo '<ul>'; }
                                    while($dataHijo5 = mysqli_fetch_array( $queryHijo5 )){
                                        $link_5 = '';
                                        if($user_log["role"] == 1){
                                            $link_5 = ' href="'.$url.'?pg=administrar/area/detalle&id='.$dataHijo5["id"].'" '; 
                                        }
