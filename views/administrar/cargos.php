            ...
            <tr>
                ...
                <th scope="col" width="100" align="center">
                    <?php if($user_log["role"] == 1){ ?>
                        <a href="<?php echo $url; ?>?pg=administrar/cargo/detalle">
        ...
        <tbody class="tabla_lista">
            <?php
                ...
                while($data = mysqli_fetch_array($query)){ 
					...
					$queryGerencia = mysqli_query($connect_valentina,"SELECT * FROM Gerencias WHERE id = '".$data["id_gerencia"]."'");  
