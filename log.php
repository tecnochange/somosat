<?php
    ...
    $_SESSION['token_crf'] = md5(uniqid(mt_rand(), true));
...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Hr Suite Viva - Somos At">
            ...
            <div class="col-md-12">
                <main class="form-signin">
                    <?php echo $respuesta; ?>
                        ...
                        <div style="background: #ffffff5c; border-radius: 15px; padding: 10px 30px; margin-bottom: 15px;">
					...
					<a href="log_sso.php">
					<button class="w-100 btn btn-lg btn-primary" type="button" style="border-radius: 30px; border: 0px; background-color: #00b49f54; margin-top: 0px">
                        Office 365
                    </button>
					</a>
